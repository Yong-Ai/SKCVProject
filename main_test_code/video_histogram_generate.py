# from https://github.com/nrsyed/computer-vision/blob/master/real_time_histogram/real_time_histogram.py
import numpy as np
...
capture = cv2.VideoCapture('../resource/2ms.mp4')

color = 'rgb' #args['color']
bins = 16 #args['bins']
resizeWidth = 1024 #args['width']
